...
class ImageDisplay(QWidget):
    ...
    def start_processing(self):
        ...
        # Apply consistent font and alignment settings for image labels
        for label in [
            self.original_label,
            self.enhanced_label,
            self.edges_label,
            ...
            label.setFixedSize(480, 360)  # Set consistent label size

        # Create descriptive labels for each image feed
        original_feed_label = QLabel("Original Image")
        enhanced_feed_label = QLabel("Enhanced Image")
        edges_feed_label = QLabel("Edge Detection")
        annotated_feed_label = QLabel("YOLOv8 Detection")

        # Apply consistent font for description labels
        for desc_label in [
            original_feed_label,
            enhanced_feed_label,
            edges_feed_label,
            annotated_feed_label,
        ]:
            desc_label.setFont(QFont("Arial", 16))
            desc_label.setAlignment(Qt.AlignCenter)

        # Organize the labels into the grid layout
        self.grid_layout.addWidget(original_feed_label, 1, 0)
        self.grid_layout.addWidget(self.original_label, 2, 0)

        self.grid_layout.addWidget(enhanced_feed_label, 1, 1)
        self.grid_layout.addWidget(self.enhanced_label, 2, 1)

        self.grid_layout.addWidget(edges_feed_label, 3, 0)
        self.grid_layout.addWidget(self.edges_label, 4, 0)

        self.grid_layout.addWidget(annotated_feed_label, 3, 1)
        self.grid_layout.addWidget(self.annotated_label, 4, 1)
    ...
    def resize_labels(self):
        """Resizes labels to maintain image feed dimensions."""
        for label in [
            self.original_label,
            self.enhanced_label,
            self.edges_label,
            ...
            label.setFixedSize(480, 360)  # Consistent size for image feeds
